...
class PSDWithLoss(nn.Cell):
    ...
    def construct(self, feature, aug_feature, labels, input_inds, cloud_inds, p0, p1, p2, p3, p4, n0, n1, n2, n3, n4, pl0, pl1, pl2,
        ...
        for ign_label in self.ignored_label_inds:
            ignore_mask = P.logical_or(ignore_mask, P.Equal()(global_labels, ign_label))
